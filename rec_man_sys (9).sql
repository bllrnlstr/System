...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2024 at 07:23 AM
...
INSERT INTO `student_info` (`stud_id`, `lrn_num`, `f_name`, `m_name`, `l_name`, `suffix`, `year_lvl`, `course`, `address`, `age`, `emerg_name`, `emerg_num`, `emerg_address`, `sections`, `user_id`) VALUES
(14, '1', 'Lester ', 'Buendicho', 'Ballaran', '', '2', 'Tambay', 'haah', 2, 'haha', '21312321', 'haha', '1111', NULL),
(15, '2', 'Jhon Xyrone', 'Azuelo', 'Rizal', '', '2', 'Professional Tambay', 'Molo', 22, 'Ballaran', '21312321', 'ASDASDS', '1113', NULL);
...
INSERT INTO `subjects` (`subject_id`, `subject_name`, `teacher_id`, `sections`) VALUES
(5, 'ICT', 5, '1111');
...
INSERT INTO `teacher_info` (`teacher_id`, `name`, `sections`) VALUES
(5, 'Rodel Simba', '1111');
...
(14, 'teacher', 'ash', 'rodelsim@gmail.com', '123'),
(15, 'teacher', 'Kuroo', 'rodelsim@gmail.com', '123'),
(16, 'student', 'ter', '', 'ter'),
(17, 'student', '12345', '', '123');
...
ALTER TABLE `student_info`
  ...
  ADD KEY `student_info_ibfk_1` (`user_id`);
...
--
ALTER TABLE `announcements`
  ADD CONSTRAINT `announcements_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_info` (`teacher_id`);

--
-- Constraints for table `deadlines`
--
ALTER TABLE `deadlines`
  ADD CONSTRAINT `deadlines_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_info` (`teacher_id`);

--
-- Constraints for table `enrolled_students`
--
ALTER TABLE `enrolled_students`
  ADD CONSTRAINT `enrolled_students_ibfk_1` FOREIGN KEY (`stud_id`) REFERENCES `student_info` (`stud_id`);

--
-- Constraints for table `events`
--
ALTER TABLE `events`
  ADD CONSTRAINT `events_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_info` (`teacher_id`);
...
--
ALTER TABLE `student_info`
  ADD CONSTRAINT `student_info_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `subjects`
--
ALTER TABLE `subjects`
  ADD CONSTRAINT `subjects_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_info` (`teacher_id`);
COMMIT;
